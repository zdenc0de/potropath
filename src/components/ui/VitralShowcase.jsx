...
function VitralShowcase({ caption = 'El vitral de nuestra biblioteca', className = '' }) {
  ...
  return (
    <figure className={`relative ${className}`}>
      <div className="overflow-hidden rounded-xl shadow-lg shadow-ink/10 ring-1 ring-ink/5">
        {imageFailed ? (
      ...
      <img
        ...
        className="absolute -bottom-6 -right-4 h-24 w-auto rounded-xl bg-paper p-1.5 shadow-lg ring-1 ring-ink/10 sm:h-28 md:-right-6 md:h-32"
      />
    </figure>
  )
}
